<script setup>
  ...
  defineEmits(['incrementar-cantidad', 'disminuir-cantidad', 'eliminar-guitarra-del-carrito', 'agregar-carrito', 'vaciar-carrito'])
                                        ...
                                        >
                                            ...
                                            <td>
                                                <button
                                                    ...
                                                    type="button"
                                                    @click="$emit('eliminar-guitarra-del-carrito', producto.id)"
                                                >
                                                    X
                                                </button>
                                            </td>
